...
mkdir build-Scilab-Release-Redistribuable
cd build-Scilab-Release-Redistribuable
!CMAKE!\bin\cmake.exe -DBTK_WRAP_SCILAB:BOOL=1 -DBTK_WRAP_SCILAB_REDISTRIBUABLE_MEX_FILES:BOOL=1 -DCMAKE_BUILD_TYPE:CHAR=Release -G "NMake Makefiles" ..
