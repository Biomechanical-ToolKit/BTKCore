...
if ~isequal(size(params.A), size(params.B))
    message = comparisonMessage(params.Message, ...
        ...
        params.A, params.B);
    error('assertVectorsAlmostEqual:sizeMismatch', ...
        '%s', message);
end
...
if ~(isfloat(params.A) && isfloat(params.B))
    message = comparisonMessage(params.Message, ...
        ...
        params.A, params.B);
    error('assertVectorsAlmostEqual:notFloat', ...
        '%s', message);
end

if ~compareFloats(params.A, params.B, 'vector', ...
    ...
    message = comparisonMessage(params.Message, tolerance_message, ...
        params.A, params.B);
    error('assertVectorsAlmostEqual:tolExceeded', ...
        '%s', message);
end
