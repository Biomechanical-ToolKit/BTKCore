...
IF(BTK_USE_SYSTEM_EIGEN2)
  SET(BTK_EIGEN2_INCLUDE_DIR ${EIGEN2_INCLUDE_DIR})
...
# The library dependencies file.
SET(BTK_LIBRARY_DEPENDS_FILE "\${BTK_INSTALL_PREFIX}${BTK_INSTALL_PACKAGE_DIR}/BTKLibraryDepends.cmake")

# The "use" file.
SET(BTK_USE_FILE \${BTK_INSTALL_PREFIX}${BTK_INSTALL_PACKAGE_DIR}/UseBTK.cmake)

# The build settings file.
SET(BTK_BUILD_SETTINGS_FILE \${BTK_INSTALL_PREFIX}${BTK_INSTALL_PACKAGE_DIR}/BTKBuildSettings.cmake)
...
STRING(REGEX REPLACE "/" ";" BTK_INSTALL_PACKAGE_DIR_COUNT
  "${BTK_INSTALL_PACKAGE_DIR}")
SET(BTK_CONFIG_CODE "
...
FOREACH(p ${BTK_INSTALL_PACKAGE_DIR_COUNT})
  SET(BTK_CONFIG_CODE
