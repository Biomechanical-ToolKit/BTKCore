...
ELSE(WIN32)
  ...
  IF(APPLE)
    ...
    ELSE(CMAKE_OSX_ARCHITECTURES MATCHES i386 OR CMAKE_OSX_ARCHITECTURES MATCHES x86_64)
  ...
  FIND_PATH(MATLAB_ROOT "license.txt" ${MATLAB_PATHS})
  IF(NOT MATLAB_ROOT)
    MESSAGE("Linux/MacOS users have to set the Matlab installation path into the MATLAB_ROOT variable")
  ENDIF(NOT MATLAB_ROOT)
  IF(CMAKE_SIZEOF_VOID_P EQUAL 4)
    # Regular x86
