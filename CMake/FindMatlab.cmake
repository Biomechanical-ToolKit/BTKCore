...
ELSE(WIN32)
  ...
  IF(APPLE)
    ...
    ELSE(CMAKE_SIZEOF_VOID_P EQUAL 4)
      ...
      ELSE(EXISTS "${MATLAB_ROOT}/bin/maci64/")
        MESSAGE("You use a Matlab 32 bits version on a 64 bits OS. BTK will be compiled in 32 bits to be useable with your Matlab version.")
        SET(MATLAB_LIBRARIES_PATHS "${MATLAB_ROOT}/bin/maci")
        SET(MATLAB_MEXFILE_EXT mexmaci)
  ...
  ELSE(APPLE)
    ...
    SET(MATLAB_PATHS ${MATLAB_LOCAL_PATHS} ${MATLAB_OPT_PATHS} ${MATLAB_USR_PATHS})
