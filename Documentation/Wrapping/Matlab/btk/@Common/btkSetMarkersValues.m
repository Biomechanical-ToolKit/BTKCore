function mv = btkSetMarkersValues(h) %#ok
%BTKSETMARKERSVALUES Sets markers' coordinates from a matrix
% 
%  BTKSETMARKERSVALUES(H, MV) uses the matrix MV to sets markers' coordinates.
%  The number of rows of the matrix corresponds to the number of point's frame. 
