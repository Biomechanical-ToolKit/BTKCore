...
%BTKGET3DPOINTS Extract points from a biomechanical acquisition
% 
%  POINTS = BTKGET3DPOINTS(H) returns a structure of points.  Each 
...
%
%  [POINTS POINTSINFO] = BTKGET3DPOINTS(H) returns points' informations  
...
error(generatemsgid('NotSupported'),'MEX file for BTKGET3DPOINTS not found');
