...
class C3DFileWriterTest(unittest.TestCase):
  ...
  def test_sample01_Eb015pi_rewrited(self):
    ...
    self.assertAlmostEqual(acq.GetPoint(0).GetValues().GetCoeff(8,0), 250.4166, 3)
    self.assertAlmostEqual(acq.GetPoint(17).GetValues().GetCoeff(16,0), 285.0, 3)
    self.assertAlmostEqual(acq.GetPoint(17).GetValues().GetCoeff(16,1), 222.4166, 3)
    self.assertAlmostEqual(acq.GetPoint(17).GetValues().GetCoeff(16,2), 564.4166, 3)
    self.assertAlmostEqual(acq.GetPoint(0).GetResiduals().GetCoeff(0), 1.3333, 3)
    self.assertAlmostEqual(acq.GetPoint(14).GetResiduals().GetCoeff(20), 1.91667, 3)
    self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(0), -26.6599, 3)
    self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(1), -25.8, 3)
    
    acqRef = reader.GetOutput()
    for i in range(0,50):
      self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(i), acqRef.GetAnalog(0).GetValues().GetCoeff(i), 4)
      self.assertAlmostEqual(acq.GetAnalog(1).GetValues().GetCoeff(i), acqRef.GetAnalog(1).GetValues().GetCoeff(i), 4)
      self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(i), acqRef.GetAnalog(0).GetValues().GetCoeff(i), 4)
      self.assertAlmostEqual(acq.GetAnalog(1).GetValues().GetCoeff(i), acqRef.GetAnalog(1).GetValues().GetCoeff(i), 4)
  ...
  def test_sample01_Eb015pr_rewrited(self):
    ...
    acqRef = reader.GetOutput()
    for i in range(0,50):
      self.assertAlmostEqual(acq.GetPoint(0).GetResiduals().GetCoeff(i), acqRef.GetPoint(0).GetResiduals().GetCoeff(i), 3)
      self.assertAlmostEqual(acq.GetPoint(14).GetResiduals().GetCoeff(i), acqRef.GetPoint(14).GetResiduals().GetCoeff(i), 3)
      self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(i), acqRef.GetAnalog(0).GetValues().GetCoeff(i), 4)
      self.assertAlmostEqual(acq.GetAnalog(1).GetValues().GetCoeff(i), acqRef.GetAnalog(1).GetValues().GetCoeff(i), 4)
  ...
  def test_sample09_PlugInC3D_rewrited(self):
    ...
    for i in range(0,50):
      for j in range(0,acq.GetPointNumber()):
        self.assertAlmostEqual(acq.GetPoint(j).GetValues().GetCoeff(i,0), acq2.GetPoint(j).GetValues().GetCoeff(i,0), 4)
        self.assertAlmostEqual(acq.GetPoint(j).GetValues().GetCoeff(i,1), acq2.GetPoint(j).GetValues().GetCoeff(i,1), 4)
        self.assertAlmostEqual(acq.GetPoint(j).GetValues().GetCoeff(i,2), acq2.GetPoint(j).GetValues().GetCoeff(i,2), 4)
        self.assertAlmostEqual(acq.GetPoint(j).GetResiduals().GetCoeff(i), acq2.GetPoint(j).GetResiduals().GetCoeff(i), 4)
        self.assertAlmostEqual(acq.GetPoint(j).GetMasks().GetCoeff(i), acq2.GetPoint(j).GetMasks().GetCoeff(i), 4)
      for j in range(0,acq.GetAnalogNumber()):
        self.assertAlmostEqual(acq.GetAnalog(j).GetValues().GetCoeff(i), acq2.GetAnalog(j).GetValues().GetCoeff(i), 4)
  ...
  def test_sample19_sample19_rewrited(self):
    ...
    for i in range(0,50, 10):
      self.assertAlmostEqual(acq.GetAnalog(0).GetValues().GetCoeff(i), acq2.GetAnalog(0).GetValues().GetCoeff(i), 4)
      self.assertAlmostEqual(acq.GetAnalog(1).GetValues().GetCoeff(i), acq2.GetAnalog(1).GetValues().GetCoeff(i), 4)
  ...
  def test_convertTRC2C3D(self):
    ...
    self.assertAlmostEqual(acq.GetPoint(70).GetResiduals().GetCoeff(82), -1.0, 5)
    ...
    self.assertEqual(acq.GetPointUnit(), acq2.GetPointUnit())
    for i in range(0,50):
      self.assertAlmostEqual(acq.GetPoint(1).GetValues().GetCoeff(i,0), acq2.GetPoint(1).GetValues().GetCoeff(i,0), 4)
      self.assertAlmostEqual(acq.GetPoint(2).GetValues().GetCoeff(i,1), acq2.GetPoint(2).GetValues().GetCoeff(i,1), 4)
      self.assertAlmostEqual(acq.GetPoint(3).GetValues().GetCoeff(i,2), acq2.GetPoint(3).GetValues().GetCoeff(i,2), 4)
      self.assertAlmostEqual(acq.GetPoint(4).GetResiduals().GetCoeff(i), acq2.GetPoint(4).GetResiduals().GetCoeff(i), 4)

    self.assertAlmostEqual(acq.GetPoint(70).GetResiduals().GetCoeff(82), acq2.GetPoint(70).GetResiduals().GetCoeff(82), 5)
