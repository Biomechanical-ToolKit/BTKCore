...
CXXTEST_SUITE(EigenIIRFilterDesignTest)
{
  ...
  CXXTEST_TEST(Butter_pass_7_0Dot2_0Dot8)
  {
    ...
    TS_ASSERT_DELTA(a(11), 3.1717384177005001e-15 , 5e-15);
  ...
  CXXTEST_TEST(Internal_lp2bp_default)
  {
    ...
    TS_ASSERT_DELTA(a(3).imag(), -4.4408920985006262e-16, 1e-15);
    TS_ASSERT_DELTA(a(4).real(),  28.944271909999152, 1e-14);
    TS_ASSERT_DELTA(a(4).imag(), -1.8873791418627661e-15, 1e-15);
    ...
    TS_ASSERT_DELTA(a(6).imag(), -1.8873791418627661e-15, 1e-15);
    TS_ASSERT_DELTA(a(7).real(),  18.180339887498953, 1e-14);
    TS_ASSERT_DELTA(a(7).imag(), -4.4408920985006262e-16, 1e-15);
