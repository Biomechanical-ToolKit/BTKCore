...
CXXTEST_SUITE(C3DFileReaderTest)
{
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/DEC_INT.C3D");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_EQUALS(acq->GetMarkerFrequency(), 50);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 36);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 89);
    TS_ASSERT_EQUALS(acq->GetAnalogFrequency(), 200);
    TS_ASSERT_EQUALS(acq->GetAnalogNumber(), 16);
		TS_ASSERT_EQUALS(acq->GetAnalogFrameNumber(), 89 * 4);

		TS_ASSERT_EQUALS(acq->GetMarker(3)->GetLabel(), "RSK1");
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,0), 384.0944, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,1), 523.8418, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,2), 311.2683, 0.0001);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/Dec_real.c3d");
		reader->Update();
    btk::Acquisition::Pointer acq = reader->GetOutput();
    ...
    TS_ASSERT_EQUALS(acq->GetAnalogNumber(), 16);
		...
		TS_ASSERT_EQUALS(acq->GetMarker(3)->GetLabel(), "RSK1");
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,0), 384.0944, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,1), 523.8417, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,2), 311.2683, 0.0001);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/pc_int.c3d");
		reader->Update();
    btk::Acquisition::Pointer acq = reader->GetOutput();
    ...
    TS_ASSERT_EQUALS(acq->GetAnalogNumber(), 16);
		...
		TS_ASSERT_EQUALS(acq->GetMarker(3)->GetLabel(), "RSK1");
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,0), 384.0944, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,1), 523.5606, 0.0001);
		TS_ASSERT_DELTA(acq->GetMarker(3)->GetValues()(16,2), 311.2683, 0.0001);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/pc_real.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/sgi_int.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample02/sgi_real.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample05/vicon512.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_EQUALS(acq->GetMarkerFrequency(), 120);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 45);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 6492);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample06/MACsample.c3d");
		reader->Update();
	};
	...
	CXXTEST_TEST(Sample08_TEST)
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
		// TESTAPI
    reader->SetFilename(C3DFilePath + "sample08/TESTAPI.c3d");
		reader->Update();
		btk::Acquisition::Pointer TESTAPI = reader->GetOutput();
		// TESTBPI
		reader->SetFilename(C3DFilePath + "sample08/TESTBPI.c3d");
		reader->Update();
		btk::Acquisition::Pointer TESTBPI = reader->GetOutput();
    // TESTCPI
		reader->SetFilename(C3DFilePath + "sample08/TESTCPI.c3d");
		reader->Update();
		btk::Acquisition::Pointer TESTCPI = reader->GetOutput();
		// TESTDPI
		reader->SetFilename(C3DFilePath + "sample08/TESTDPI.c3d");
		reader->Update();
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample13/Dance.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_DELTA(acq->GetMarkerFrequency(), 65.05, 0.01);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 40);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 499);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample13/golfswing.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_DELTA(acq->GetMarkerFrequency(), 107.53, 0.01);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 29);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 514);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample15/FP1.C3D");
		reader->Update();
	};
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample15/FP2.C3D");
		reader->Update();
	};
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample18/bad_parameter_section.c3d");
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample19/sample19.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_EQUALS(acq->GetMarkerFrequency(), 60);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 0);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 34672);
    TS_ASSERT_EQUALS(acq->GetAnalogFrequency(), 1080);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample20/phasespace_sample.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();

		TS_ASSERT_EQUALS(acq->GetMarkerFrequency(), 30);
    TS_ASSERT_EQUALS(acq->GetMarkerNumber(), 40);
    TS_ASSERT_EQUALS(acq->GetMarkerFrameNumber(), 701);
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample21/sample21.c3d");
		reader->Update();
	};
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample22/BKINtechnologies.c3d");
		reader->Update();
		btk::Acquisition::Pointer acq = reader->GetOutput();
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample28/dynamic.c3d");
		reader->Update();
	};
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample28/standing.c3d");
		reader->Update();
	};
  ...
  {
    btk::AcquisitionFileReader::Pointer reader = btk::AcquisitionFileReader::New();
    reader->SetFilename(C3DFilePath + "sample28/type1.c3d");
		reader->Update();
	};
};
